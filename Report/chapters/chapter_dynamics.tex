...
Wind affects the MAV dynamics in two ways. On one hand it causes pressure on the multirotor surface opposed to the wind field. We call this load area force $\mathbf{F}_A$. On the other hand the wind field influences the total rotor drag. We call this load drag force $\mathbf{F}_D$.

The area force is given by

Following rotor blade theory, the drag force is given as in equation \ref{eq:drag_force}.

For small air speeds the rotor drag force is 
