...
\blankpage{Model}
\input{slides/01_starting_point}
\input{slides/02_wind_drag}
\input{slides/03_wind_model}
\blankpage{Control Approach}
\input{slides/04_cascaded_control}
\input{slides/05_control_system}
\input{slides/06_rhc}
\input{slides/07_characteristics_mpc}
\blankpage{Control Realization}
\input{slides/08_linear_mpc}
\input{slides/09_linear_mpc_ocp}
\input{slides/10_linear_mpc_algo}
\input{slides/11_nonlinear_mpc}
\input{slides/12_nonlinear_mpc_ocp}
\input{slides/13_nonlinear_mpc_algo}
\blankpage{Simulation Results}
\input{slides/14_step_response_mpc}
\input{slides/15_step_response_nmpc}
\input{slides/16_wind_mpc}
\input{slides/17_wind_nmpc}
\input{slides/18_computation}
\blankpage{Conclusion}
\input{slides/19_result}
